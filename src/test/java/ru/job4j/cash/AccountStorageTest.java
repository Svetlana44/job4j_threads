...
class AccountStorageTest {
    ...
    void getById() {
        ...
        Account expected = new Account(1, 100);
        storage.add(expected);
        assertThat(storage.getById(1)).get().isEqualTo(expected);
    }
    ...
    @Test
    void whenTransferEmptyAccounts() {
        var storage = new AccountStorage();
    ...
    @Test
    void whenTransferEmptySecondAccount() {
        var storage = new AccountStorage();
        storage.add(new Account(1, 100));
        assertThatThrownBy(() -> storage.transfer(1, 2, 100))
                .isInstanceOf(IllegalStateException.class)
